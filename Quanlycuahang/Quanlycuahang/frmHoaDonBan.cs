...
using COMExcel = Microsoft.Office.Interop.Excel;   // khai báo thư viện SD Excel 
...
namespace Quanlycuahang
{
    public partial class frmHoaDonBan : Form
    {
        ...
        private void LoadInfoHoaDon()       //nạp chi tiết hóa đơn vào 
        {
            string str;
            str = "SELECT NgayBan FROM tblHDBan WHERE MaHDBan = N'" + txtMaHoaDon.Text + "'";
            dtpNgayBan.Value = DateTime.Parse(Functions.GetFieldValues(str)); //convert string 
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            ResetValues();
            txtMaHoaDon.Text = Functions.CreateKey("HDB");   //tạo mã hóa đơn với tiền tố được chọn 
            LoadDataGridView();
        }
        private void ResetValues()  //reset các giá trị 
        {
            txtMaHoaDon.Text = "";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "INSERT INTO tblChiTietHDBan(MaHDBan,MaHang,SoLuong,DonGia, GiamGia,ThanhTien) VALUES(N'" + txtMaHoaDon.Text.Trim() + "',N'" + cboMaHang.SelectedValue + "'," + txtSoLuong.Text + "," + txtDonGiaBan.Text + "," + txtGiamGia.Text + "," + txtThanhTien.Text + ")";
            Functions.RunSQL(sql);
            LoadDataGridView();
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            // Thiết lập định dạng chung cho các địa chỉ excel  
            exRange = exSheet.Cells[1, 1];
            exRange.Range["A1:Z300"].Font.Name = "Times new roman"; //Font chữ
            exRange.Range["A1:B3"].Font.Size = 10;
            exRange.Range["A1:B3"].Font.Bold = true;
            exRange.Range["A1:B3"].Font.ColorIndex = 5; // xanh nước biển
            exRange.Range["A1:A1"].ColumnWidth = 7;
            exRange.Range["B1:B1"].ColumnWidth = 15;
            exRange.Range["A1:B1"].MergeCells = true;
            exRange.Range["A1:B1"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A1:B1"].Value = "Cửa hàng L ";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = " Hà Nội";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: (04)81640027";
            ...
            exRange.Range["C6:E6"].Value = tblThongtinHD.Rows[0][0].ToString();  //lấy dl từ data base vào excel 
        ...
        private void txtSoLuong_KeyPress(object sender, KeyPressEventArgs e)  // chỉ được nhập các số nguyên 
        {
        ...
        private void dgvHoaDonBanHang_DoubleClick(object sender, EventArgs e)  // chỉ xóa 1 mặt hàng trong 1 hóa đơn nhiều hàng
        {
