    ...
    public partial class frmDMNhanVien : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (chkGioiTinh.Checked == true)
                ...
                gt = "Nữ";
            sql = "SELECT MaNhanVien FROM tblNhanVien WHERE MaNhanVien=N'" + txtMaNhanVien.Text.Trim() + "'";  //check xem có nhập 2 mã trùng nhau 
            ...
            // Cau truc : INSERT INTO tblTenbang(Tencot) VALUES ( Gia tri )
            sql = "INSERT INTO tblNhanVien(MaNhanVien,TenNhanVien,GioiTinh,DiaChi,DienThoai,NgaySinh) VALUES (N'" + txtMaNhanVien.Text.Trim() + "',N'" + txtTenNhanVien.Text.Trim() + "',N'" + gt + "',N'" + txtDiaChi.Text.Trim() + "','" + mtbDienThoai.Text + "','" + dtpNgaySinh.Value + "')";    // N : unicode để có thể viết chữ tiếng việt
        ...
        {
            string sql, gt;
            if (tblNV.Rows.Count == 0) //Kiểm tra có DL k 
            {
                MessageBox.Show("Không có dữ liệu!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            sql = "UPDATE tblNhanVien SET TenNhanVien=N'" + txtTenNhanVien.Text.Trim().ToString() +
                    ...
                    "' WHERE MaNhanVien=N'" + txtMaNhanVien.Text + "'";  // de y WHERE
            Functions.RunSQL(sql);
            LoadDataGridView();
            ResetValues();
            btnBoQua.Enabled = false;
